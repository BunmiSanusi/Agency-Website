...
const SectionEight = () => {
  return (
    <section className="bg-white py-20 px-4 md:px-8 lg:px-20">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 place-items-center overflow-hidden">
        {content.map((item, index) => (
          ...
          >
            <div className="w-full max-w-[368px] h-[286px] relative rounded-[8px] overflow-hidden shadow">
              <Image
                src={item.image}
                alt={`Post ${index + 1}`}
                fill
